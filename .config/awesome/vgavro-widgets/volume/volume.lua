...
return function(options)
    ...
    vicious.register({}, vicious.widgets.volume, function(_, args)
        ...
        if args[2] == "♩" then
            imagebox:set_image(dir .. '/audio-volume-muted.png')
        elseif args[1] >= 66 then
            imagebox:set_image(dir .. '/audio-volume-high.png')
        elseif args[1] >= 33 then
            imagebox:set_image(dir .. '/audio-volume-medium.png')
        else
            imagebox:set_image(dir .. '/audio-volume-low.png')
        end
